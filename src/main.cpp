...
// Copyright (c) 2013 The Vanillacoin developers
...
uint256 hashGenesisBlock("0x00000b7b3036cf9fdb8c7349e7a048a7cfbb44f947e42921483e32f2d340d31c");
static const unsigned int timeGenesisBlock = 1389537802;
...
const string strMessageMagic = "Vanillacoin Signed Message:\n";
...
static const int64 nBlockRewardStartCoin = 50 * COIN;//50 * COIN;
...
*/
        ...
        block.nNonce   = 862633498; //121120130832;

        if (fTestNet)
        {
            block.nTime    = 1389537802;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xe608a3b97bad773ac7fe00f42fc5546a2a555c1473275b6a070e0b68c768e490"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VanillacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VanillacoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("VanillacoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("vanillacoin-miner");
    ...
    try { loop {
        ...
        printf("Running VanillacoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("VanillacoinMiner terminated\n");
        throw;
    }
}
