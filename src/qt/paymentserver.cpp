...
const QString BITCOIN_IPC_PREFIX("vanillacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click vanillacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start vanillacoin: click-to-pay handler");
    else
...
{
    // clicking on vanillacoin: URLs creates FileOpen events on the Mac:
