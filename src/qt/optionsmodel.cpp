...
{
    QSettings settings;
    CService addrProxy(settings.value("addrProxy", "127.0.0.1:9070").toString().toStdString());
...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::VLD).toInt();
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case ProxyIP: {
            proxyType proxy;
            proxy.first = CService("127.0.0.1", 9070);
